...
is a signal sent from a device or from [[software]] to the microprocessor. This will cause the microprocessor to temporarily sop what it is doing so that it can service the interrupt. 
